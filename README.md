...
tenki is a chat bot built on the [Hubot][hubot] framework. It was
...
export HUBOT_RAINFALL_ALERT_CRONTIME="0 */10 0,9-23 * * *"
export HUBOT_RAINFALL_ALERT_LAT=""
export HUBOT_RAINFALL_ALERT_LON=""
export HUBOT_RAINFALL_ALERT_LAT_FOR_MAP=""
export HUBOT_RAINFALL_ALERT_LON_FOR_MAP=""
...
You can start tenki locally by running:
...
Then you can interact with tenki by typing `tenki help`.

    tenki> tenki help
    tenki animate me <query> - The same thing as `image me`, except adds [snip]
    tenki help - Displays all of the help commands that tenki knows about.
    ...
